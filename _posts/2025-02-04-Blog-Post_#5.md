...
<script src="https://cdn.jsdelivr.net/npm/vega@5.31.0"></script> <script src="https://cdn.jsdelivr.net/npm/vega-lite@5.23.0"></script> <script src="https://cdn.jsdelivr.net/npm/vega-embed@6.29.0"></script>
<script type="text/javascript"> var spec = "https://raw.githubusercontent.com/aaravamin15/aaravamin15.github.io/refs/heads/master/assets/charts/chart.json"; vegaEmbed('#vis', spec).then(function(result) { // Access the Vega view instance (https://vega.github.io/vega/docs/api/view/) as result.view }).catch(console.error); </script>
...
<script>
  const spec = "assets/charts/solar.json";
  vegaEmbed('#vis', spec);
</script>
...
<script type="text/javascript"> var spec = "https://github.com/aaravamin15/aaravamin15.github.io/blob/3be7ece8b3a97b3b2024f4f5c1d3f26ee0da592a/assets/charts/solar.json"; vegaEmbed('#vis', spec).then(function(result) { // Access the Vega view instance (https://vega.github.io/vega/docs/api/view/) as result.view }).catch(console.error); </script>
