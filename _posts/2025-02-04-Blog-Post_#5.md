...
I was inspired by an article from the [New York Times](https://www.nytimes.com/interactive/2025/01/30/science/mars-landing-trump.html) 

## The Dataset

For this project, I generated synthetic data representing planetary positions over time. The dataset includes Earth and Mars, along with a calculated position for Mars offset by seven months. Here’s how I structured the data:
...
Finally, I combined everything into an interactive visualization where users can explore planetary positions over time. Below is an example of how you might embed this in a web page:
...
This project was a great way to experiment with orbital mechanics and interactive data visualization. By incorporating a time slider, I was able to create a dynamic representation of planetary movement, including predicting Mars’ position seven months ahead.

## References

- Used ChatGPT to help with some of the math associated with simulating the positions of the planets over time.
- Learned about interactive visualization from [Altair's documentation](https://altair-viz.github.io/).
